...
public class RotationMonitor extends AbstractMonitor {
    ...
    public static MessageWritable weChatWriter;
    ...
    public void report(MessageWritable writer, int rotation) {
    ...
    public static class WeChatReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals("jp.co.cyberagent.stf.receiver")) {
                String text = intent.getExtras().getString("msg");
                String ident=intent.getExtras().getString("flag");
                if (text != null) {
                    Log.e("Kageboshi", text);
                    weChatWriter.write(Wire.Envelope.newBuilder()
                        .setType(Wire.MessageType.EVENT_NOTIFICATION)
                        .setMessage(Wire.NotificationEvent.newBuilder()
                            .setNotification(1)
                            .setContent(text)
                            .setIdent(ident)
                            .build()
